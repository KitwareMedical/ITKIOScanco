...
void ScancoImageIO::PrintSelf(std::ostream & os, Indent indent) const
{
...
void ScancoImageIO::SetDataFileName(const char *filename)
{
...
bool ScancoImageIO::CanReadFile(const char *filename)
{
...
void ScancoImageIO::ReadImageInformation()
{
